...
class mod_activitystatus_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('select', 'itemsperrow', get_string('itemsperrow', 'mod_activitystatus'), $itemsoptions);
    ...
    public function definition_after_data() {
        ...
        if ($mform->elementExists('itemsperrow')) {
            $itemsperrow = $DB->get_field('activitystatus', 'itemsperrow', ['id' => $this->_instance]);
            $mform->setDefaults('itemsperrow', !empty($itemsperrow) ? $itemsperrow : 0);
        }
