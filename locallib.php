...
function activitystatus_load_items_per_row($instance) {
    global $DB;
    $itemsperrow = $DB->get_field('activitystatus', 'itemsperrow', ['id' => $instance]);
    return $itemsperrow;
}

function activitystatus_save_items_per_row($instance, $itemsperrow) {
    global $DB;
    $DB->set_field('activitystatus', 'itemsperrow', $itemsperrow, ['id' => $instance]);
}
